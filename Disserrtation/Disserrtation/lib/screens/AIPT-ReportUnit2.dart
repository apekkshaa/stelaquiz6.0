...
class PdfPageUnit2 extends StatefulWidget {
  @override
  _PdfPageUnit2State createState() => _PdfPageUnit2State();
}


class _PdfPageUnit2State extends State<PdfPageUnit2> {
  String? totalMarks;
  String? code;
  String? starttime;
  String? endtime;
  ...
  Future<void> fetchDataFromDatabase() async {
    final DatabaseReference databaseReference = FirebaseDatabase.instanceFor(
      ...
      final DatabaseEvent event =
          await databaseReference.child('AIPT-Unit2').child(enrollmentNo).once();
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              pw.Center(
  child: pw.Text(
    'Report of AIPT', // Your heading text
...
pw.RichText(
  ...
  text: TextSpan(
    children: [
      TextSpan(
        text: 'Report of AIPT', // Your heading text
