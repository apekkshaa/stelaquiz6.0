...
class SEResultUnit4 extends StatelessWidget {
  @override
...
class _COAMCQTablePageState extends State<COAMCQTablePage> {
  ...
  databaseReference.child('SE-Unit4').once().then((DatabaseEvent event) {
...
values.forEach((key, value) {
 ...
 void _exportToExcel() async {
  ...
  final anchor = html.AnchorElement(href: url)
    ..setAttribute("download", "SE-Unit4_MCQ_Results.csv")
    ..style.display = 'none';
