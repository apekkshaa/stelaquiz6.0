...
class PdfPageUnit3 extends StatefulWidget {
  @override
  _PdfPageUnit3State createState() => _PdfPageUnit3State();
}


class _PdfPageUnit3State extends State<PdfPageUnit3> {
  String? totalMarks;
  String? code;
  String? starttime;
  String? endtime;
  ...
  Future<void> fetchDataFromDatabase() async {
    final DatabaseReference databaseReference = FirebaseDatabase.instanceFor(
      ...
      final DatabaseEvent event =
          await databaseReference.child('AIPT-Unit3').child(enrollmentNo).once();
