...
class DSResultUnit2 extends StatelessWidget {
  @override
...
class _COAMCQTablePageState extends State<COAMCQTablePage> {
  ...
  databaseReference.child('DS-Unit2').once().then((DatabaseEvent event) {
...
values.forEach((key, value) {
 ...
 void _exportToExcel() async {
  ...
  final anchor = html.AnchorElement(href: url)
    ..setAttribute("download", "DS-Unit2_MCQ_Results.csv")
    ..style.display = 'none';
