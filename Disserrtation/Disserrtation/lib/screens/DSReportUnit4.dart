...
class DSReportUnit4 extends StatefulWidget {
  @override
  _DSReportUnit4State createState() => _DSReportUnit4State();
}


class _DSReportUnit4State extends State<DSReportUnit4> {
  String? totalMarks;
  String? code;
  String? starttime;
  String? endtime;
...
;
      ...
      final DatabaseEvent event =
          await databaseReference.child('DS-Unit4').child(enrollmentNo).once();
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              pw.Center(
  child: pw.Text(
    'Report of DS Unit-4', // Your heading text
...
pw.SizedBox(height: 10),
  ...
  text: TextSpan(
    children: [
      TextSpan(
        text: 'Report of DS-Unit4', // Your heading text
