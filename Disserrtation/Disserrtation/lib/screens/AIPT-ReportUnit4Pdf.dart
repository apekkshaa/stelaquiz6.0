...
class PdfPageUnit4 extends StatefulWidget {
  @override
  _PdfPageUnit4State createState() => _PdfPageUnit4State();
}


class _PdfPageUnit4State extends State<PdfPageUnit4> {
  String? totalMarks;
  String? code;
  String? starttime;
  String? endtime;
  ...
  Future<void> fetchDataFromDatabase() async {
    final DatabaseReference databaseReference = FirebaseDatabase.instanceFor(
      ...
      final DatabaseEvent event =
          await databaseReference.child('AIPT-Unit4').child(enrollmentNo).once();
