...
class Anubhavassessmentpage extends StatefulWidget {
  @override
  _AnubhavassessmentpageState createState() => _AnubhavassessmentpageState();
}

class _AnubhavassessmentpageState extends State<Anubhavassessmentpage> {
  ...
  List<List<String>> questions = [
    // Python basics questions
    ["Which keyword is used to define a function in Python?", "function", "define", "def", "fun"],
    ["Which keyword is used to create an anonymous function in Python?", "anon", "lambda", "func", "def"],
    ["Which data type is used to store multiple items in a single variable?", "int", "string", "list", "float"],
    ["Which data type is used to store key-value pairs?", "set", "list", "dictionary", "tuple"],
    ["Which of the following is an immutable data type?", "list", "dictionary", "set", "tuple"],
    ["What is the output of bool(0) in Python?", "True", "False", "None", "0"],
    ["Which keyword is used to iterate over a sequence (like a list, tuple, or string)?", "while", "for", "loop", "iterate"],
    ["Which keyword is used to handle exceptions in Python?", "catch", "handle", "try", "except"],
    ["What is the default return value of a function that does not return any value?", "0", "null", "None", "undefined"],
    ["Which keyword is used to skip the current iteration of a loop and continue with the next iteration?", "skip", "continue", "break", "pass"],
  ];
  ...
  void _showResultDialog() async {
    ...
    DataSnapshot snapshot = await databaseReference.child('Annu').child(enrollmentNo).get();
    ...
    //if (!snapshot.exists) {
    await databaseReference.child('Annu').child(enrollmentNo).set({
      '1_Name': name,
