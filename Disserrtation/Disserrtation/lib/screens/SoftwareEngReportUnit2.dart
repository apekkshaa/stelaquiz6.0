...
class SEReportUnit2 extends StatefulWidget {
  @override
  _SEReportUnit2State createState() => _SEReportUnit2State();
}

class _SEReportUnit2State extends State<SEReportUnit2> {
  String? totalMarks;
  String? code;
  String? starttime;
  String? endtime;
...
;
      ...
      final DatabaseEvent event =
          await databaseReference.child('SE-Unit2').child(enrollmentNo).once();
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              pw.Center(
  child: pw.Text(
    'Report of SE Unit-2', // Your heading text
...
pw.SizedBox(height: 10),
  ...
  text: TextSpan(
    children: [
      TextSpan(
        text: 'Report of SE-Unit2', // Your heading text
