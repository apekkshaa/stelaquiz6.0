...
class SEReportUnit4 extends StatefulWidget {
  @override
  _SEReportUnit4State createState() => _SEReportUnit4State();
}
class _SEReportUnit4State extends State<SEReportUnit4> {
  String? totalMarks;
  String? code;
  String? starttime;
  String? endtime;
...
;
      ...
      final DatabaseEvent event =
          await databaseReference.child('SE-Unit4').child(enrollmentNo).once();
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              pw.Center(
  child: pw.Text(
    'Report of SE Unit-4', // Your heading text
...
pw.SizedBox(height: 10),
  ...
  text: TextSpan(
    children: [
      TextSpan(
        text: 'Report of SE-Unit4', // Your heading text
