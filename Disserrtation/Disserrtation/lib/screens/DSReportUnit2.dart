...
class DSReportUnit2 extends StatefulWidget {
  @override
  _DSReportUnit2State createState() => _DSReportUnit2State();
}

class _DSReportUnit2State extends State<DSReportUnit2> {
  String? totalMarks;
  String? code;
  String? starttime;
  String? endtime;
...
;
      ...
      final DatabaseEvent event =
          await databaseReference.child('DS-Unit2').child(enrollmentNo).once();
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              pw.Center(
  child: pw.Text(
    'Report of DS Unit-2', // Your heading text
...
pw.SizedBox(height: 10),
  ...
  text: TextSpan(
    children: [
      TextSpan(
        text: 'Report of DS-Unit1', // Your heading text
