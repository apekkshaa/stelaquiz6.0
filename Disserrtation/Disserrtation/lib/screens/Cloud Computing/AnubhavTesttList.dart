...
class CClist extends StatefulWidget {
  @override
  _CClistlistState createState() => _CClistlistState();
}

class _CClistlistState extends State<CClist> {
          ...
          child: Container(
            ...
            child: Column(
              children: [
                Container(
                    padding: EdgeInsets.all(10),
                    child: Text('Operating System LIST',
                        style: TextStyle(
                            fontSize: 20,
                  ...
                  TextButton(
                    ...
                    onPressed: () {
                      ...
                      if (enteredPin == predefinedPin) {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => CCresult()),
                        );
