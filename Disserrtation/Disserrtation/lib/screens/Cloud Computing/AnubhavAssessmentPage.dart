...
class _CCassessmentpageState extends State<CCassessmentpage> {
  ...
  List<String> correctAnswers = [
    ...
    "Creating virtual versions of resources like servers or storage", // Question 1
    "PaaS", // Question 2
    "PaaS", // Question 3
    "Provides direct access to the operating system", // Question 4
    "Managing application updates", // Question 5
    "Amazon EC2", // Question 6
    "Microsoft Azure", // Question 7
    "Data breaches and unauthorized access", // Question 8
    "Public cloud", // Question 9
    "Split between public and private cloud environments", // Question 10
  ];
  ...
  List<List<String>> questions = [
    // Cloud Computing questions
    [
      "Which of the following best describes virtualization in cloud computing?",
      "Storing data on the cloud",
      "Creating virtual versions of resources like servers or storage",
      "Encrypting data in the cloud",
      "Connecting different cloud environments"
    ],
    [
      "Which cloud service model provides a complete platform including hardware, operating system, and development tools?",
      "IaaS",
      "SaaS",
      "PaaS",
      "BPaaS"
    ...
    [
      "Which cloud model allows the customer to manage applications and data but not infrastructure or runtime?",
      "SaaS",
      "IaaS",
      "PaaS",
      "DaaS"
    ...
    [
      "Which of the following is a key benefit of IaaS?",
      "Users can avoid managing virtual machines",
      "Provides direct access to the operating system",
      "Complete software solutions are offered",
      "Only suitable for personal users"
    ],
    [
      "Which of these is NOT typically a responsibility of a SaaS user?",
    ...
    [
      "Which cloud provider offers the service “Azure Functions”?",
      "Amazon Web Services",
    ...
    [
      "What is one of the main cloud security concerns for enterprises?",
    ...
    [
      "Which type of cloud computing allows multiple tenants to share resources on a public platform?",
      "Private cloud",
      "Hybrid cloud",
      "Public cloud",
      "Community cloud"
    ...
    [
      "In a hybrid cloud model, how are resources typically distributed?",
      "All resources are local",
      "Split between public and private cloud environments",
      "Fully dependent on third-party cloud vendors",
      "Stored only in a single data center"
    ],
  ];
