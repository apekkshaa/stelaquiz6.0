...
class PdfPageUnit1 extends StatefulWidget {
  @override
  _PdfPageUnit1State createState() => _PdfPageUnit1State();
}


class _PdfPageUnit1State extends State<PdfPageUnit1> {
  String? totalMarks;
  String? code;
  String? starttime;
  String? endtime;
  ...
  Future<void> fetchDataFromDatabase() async {
    final DatabaseReference databaseReference = FirebaseDatabase.instanceFor(
      ...
      final DatabaseEvent event =
          await databaseReference.child('AIPT-Unit1').child(enrollmentNo).once();
