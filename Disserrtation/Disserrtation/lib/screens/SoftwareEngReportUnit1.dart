...
class SEReportUnit1 extends StatefulWidget {
  @override
  _SEReportUnit1State createState() => _SEReportUnit1State();
}


class _SEReportUnit1State extends State<SEReportUnit1> {
  String? totalMarks;
  String? code;
  String? starttime;
  String? endtime;
...
;
      ...
      final DatabaseEvent event =
          await databaseReference.child('SE-Unit1').child(enrollmentNo).once();
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              pw.Center(
  child: pw.Text(
    'Report of SE Unit-1', // Your heading text
...
pw.SizedBox(height: 10),
  ...
  text: TextSpan(
    children: [
      TextSpan(
        text: 'Report of SE-Unit1', // Your heading text
