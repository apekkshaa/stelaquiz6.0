...
class OSResultUnit1 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return OSMCQTablePage();
  }
}

class OSMCQTablePage extends StatefulWidget {
  @override
  _OSMCQTablePageState createState() => _OSMCQTablePageState();
}

class _OSMCQTablePageState extends State<OSMCQTablePage> {
  ...
  void getDataFromFirebase() {
    databaseReference.child('OS-Unit1').once().then((DatabaseEvent event) {
  ...
  void _exportToExcel() async {
    ...
    final anchor = html.AnchorElement(href: url)
      ..setAttribute("download", "OS-Unit1_MCQ_Results.csv")
      ..style.display = 'none';
