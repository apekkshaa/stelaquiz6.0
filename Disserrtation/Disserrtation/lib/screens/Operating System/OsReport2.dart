...
class OSReportUnit2 extends StatefulWidget {
  const OSReportUnit2({super.key});
  @override
  _OSReportUnit2State createState() => _OSReportUnit2State();
}

class _OSReportUnit2State extends State<OSReportUnit2> {
  String? totalMarks;
  String? code;
  String? starttime;
  String? endtime;
  ...
  Future<void> fetchDataFromDatabase() async {
    try {
      ...
      final DatabaseEvent event =
          await databaseReference.child('OS-Unit2').child(enrollKey).once();
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Center(
                    child: Text('Report of OS-Unit2', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                  ),
