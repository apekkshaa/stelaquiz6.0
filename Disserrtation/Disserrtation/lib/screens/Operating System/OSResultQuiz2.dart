...
class OSResultUnit2 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return OSMCQTablePage2();
  }
}

class OSMCQTablePage2 extends StatefulWidget {
  @override
  _OSMCQTablePage2State createState() => _OSMCQTablePage2State();
}

class _OSMCQTablePage2State extends State<OSMCQTablePage2> {
  ...
  void getDataFromFirebase() {
    databaseReference.child('OS-Unit2').once().then((DatabaseEvent event) {
  ...
  void _exportToExcel() async {
    ...
    final anchor = html.AnchorElement(href: url)
      ..setAttribute("download", "OS-Unit2_MCQ_Results.csv")
      ..style.display = 'none';
            ...
            (index) => TableRow(
              children: [
                ...
                if (index == 0)
                  ...
                  // Populate the third column with Firebase data
                  TableCell(
                    child: Padding(
                      padding: EdgeInsets.all(8.0),
                      child: Text(
