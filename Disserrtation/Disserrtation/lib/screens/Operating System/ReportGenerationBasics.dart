...
class PdfPageOS extends StatefulWidget {
  @override
  _PdfPageOSState createState() => _PdfPageOSState();
}

class _PdfPageOSState extends State<PdfPageOS> {
  String? totalMarks;
  String? code;
  String? starttime;
  String? endtime;
...
;
      ...
      final DatabaseEvent event =
          await databaseReference.child('OS').child(enrollmentNo).once();
      if (event.snapshot.value != null) {
        Map<dynamic, dynamic>? values =
            event.snapshot.value as Map<dynamic, dynamic>?;
        print("FIREBASE DATA: ${values}");

                  setState(() {
                    totalMarks = values == null ? "N/A":values['2_Total marks'].toString();
                        totalMarks =
                        values == null ? "N/A":  values['3_Marks obtained'].toString();
                        code =
                        values == null ? "N/A": values['9_Code'].toString() ?? "N/A";
                        starttime =
                        values == null ? "N/A": values['7_Start time'].toString();
                        endtime =
                        values == null ? "N/A": values['8_End time'].toString();
                        expname =
                        values == null ? "N/A": values['10_Aim'].toString() ?? "N/A";
                        duration =
                        values == null ? "N/A": values['11_Duration'].toString();
                        universityName=values == null ? "N/A":values['12_University Name'].toString();

                        CourseName=values == null ? "N/A":values['13_Course Name'].toString();

                        examTypeName=values == null ? "N/A":values['14_Exam Type'].toString();

                        place=values == null ? "N/A":values['15_Place'].toString();
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              pw.Center(
  child: pw.Text(
    'Report of Operating Systems', // Your heading text
...
void _captureFacultySign() async {
  ...
  text: TextSpan(
    children: [
      TextSpan(
        text: 'Report of Operating System', // Your heading text
