...
import 'AI-BasedProgrammingToolsUnit4.dart';
import 'AI-basedProgrammingToolsUnit1.dart';
import 'AI-basedProgrammingToolsUnit2.dart';
import 'AI-basedProgrammingToolsUnit3.dart';
import 'AIPT-Result-Unit2.dart';
import 'AIPT-Result-Unit1.dart';
import 'AIPT-Result-Unit3.dart';
import 'AIPT-Result-Unit4.dart';
import 'CCCodingAssessmentexperimentList.dart';

var expNum;
bool linkClicked = false;

class AIbasedProgrammingTools extends StatefulWidget {
  @override
  _AIbasedProgrammingToolsState createState() => _AIbasedProgrammingToolsState();
}

class _AIbasedProgrammingToolsState extends State<AIbasedProgrammingTools> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        backgroundColor: primaryWhite,
        appBar: AppBar(
          title: Text('AI-Based Programming Tools Quiz'),
          backgroundColor: primaryBar,
          leading: TextButton(
              onPressed: () {
                Navigator.pop(context);
                                  ...
                                  TextButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      if (enteredPin == predefinedPin) {
                                        ...
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(builder: (context) => AIbasedProgrammingToolsUnit1()),
                                        );
                          ...
                          children: [
                            ...
                            TextButton(
                              ...
                              onPressed: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => AIbasedProgrammingToolsUnit2()),
                                );
                              },
                            ),
                          ],
                          ...
                          children: [
                            ...
                            TextButton(
                              ...
                              onPressed: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => AIbasedProgrammingToolsUnit3()),
                                );
                                showDialog(
                                  context: context,
                                  builder: (BuildContext context) {
                          ...
                          children: [
                            ...
                            TextButton(
                              ...
                              onPressed: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => AIbasedProgrammingToolsUnit4()),
                                );
                              },
                            ),
                          ],
                          ...
                          children: [
                            ...
                            TextButton(
                              ...
                              onPressed: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => AIPTResultUnit1()),
                                );
                                showDialog(
                                  context: context,
                                  builder: (BuildContext context) {
                          ...
                          children: [
                            ...
                            TextButton(
                              ...
                              onPressed: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => AIPTResultUnit2()),
                                );
                                showDialog(
                                  context: context,
                                  builder: (BuildContext context) {
                                        ...
                                        TextButton(
                                          ...
                                          onPressed: () {
                                            ...
                                            if (enteredPin == predefinedPin) {
                                              ...
                                              Navigator.push(
                                                context,
                                                MaterialPageRoute(builder: (context) => AIPTResultUnit3()),
                                              );
                                              // Add this variable to track whether the link has been clicked
                                            } else {
                                              // Show an error message if the pin is incorrect
                          ...
                          children: [
                            ...
                            TextButton(
                              ...
                              onPressed: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => AIPTResultUnit4()),
                                );
                                showDialog(
                                  context: context,
                                  builder: (BuildContext context) {
