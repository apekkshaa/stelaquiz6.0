...
class AIPTResultUnit3 extends StatelessWidget {
  @override
...
class _COAMCQTablePageState extends State<COAMCQTablePage> {
  ...
  databaseReference.child('AIPT-Unit3').once().then((DatabaseEvent event) {
...
values.forEach((key, value) {
 ...
 void _exportToExcel() async {
  ...
  final anchor = html.AnchorElement(href: url)
    ..setAttribute("download", "AIPT-Unit3_MCQ_Results.csv")
    ..style.display = 'none';
