...
class DSReportUnit1 extends StatefulWidget {
  @override
  _DSReportUnit1State createState() => _DSReportUnit1State();
}


class _DSReportUnit1State extends State<DSReportUnit1> {
  String? totalMarks;
  String? code;
  String? starttime;
  String? endtime;
  ...
  Future<void> fetchDataFromDatabase() async {
    final DatabaseReference databaseReference = FirebaseDatabase.instanceFor(
      ...
      final DatabaseEvent event =
          await databaseReference.child('DS-Unit1').child(enrollmentNo).once();
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              pw.Center(
  child: pw.Text(
    'Report of DS Unit-1', // Your heading text
