...
import 'AIPT-ReportUnit3.dart';
import 'ReportGenerationCOA.dart';


class AIbasedProgrammingToolsUnit3 extends StatefulWidget {
  @override
  _AIbasedProgrammingToolsUnit3State createState() => _AIbasedProgrammingToolsUnit3State();
}

class _AIbasedProgrammingToolsUnit3State extends State<AIbasedProgrammingToolsUnit3> {
...
late String section2= controller.text;
 ...
 List<String> correctAnswers = [
  ...
  "open(\"filename\", \"r\")",  // Question 1
  "file.write()",  // Question 2
  "Closes an open file and releases system resources",  // Question 3
  ".jpg",  // Question 4
  "os.remove()",  // Question 5

  // File handling modes
  "\"r+\"",  // Question 6
  "\"r\"",  // Question 7
  "Returns the current position of the file pointer",  // Question 8
  "os.rename()",  // Question 9
  "It automatically closes the file when the block inside it is exited",  // Question 10

  // Advanced file handling
  "file.readlines()",  // Question 11
  "file.seek(0)",  // Question 12
  ".txt",  // Question 13
  "class ChildClass(ParentClass)",  // Question 14
  "Global variables",  // Question 15

  // Object-oriented programming and file operations
  "os.remove()",  // Question 16
  "\"a\"",  // Question 17
  "Forces the file to be written to disk immediately",  // Question 18
  "class MyClass:",  // Question 19
  "Open file.txt in read mode and store its content in the variable data",  // Question 20
];

List<List<String>> questions = [
  // Python file handling
  [
    "What is the correct syntax to open a file in Python for reading?",
    "open(\"filename\", \"w\")", "open(\"filename\", \"r\")", "open(\"filename\", \"a\")", "open(\"filename\")"
  ],
  [
    "Which method is used to write content to a file in Python?",
    "file.write()", "file.read()", "file.open()", "file.close()"
  ],
  [
    "What does the close() function do in Python?",
    "Closes an open file and releases system resources",
  ...
  [
    "What method is used to remove a file in Python?",
    "os.remove()", "os.rename()", "os.delete()", "os.rmdir()"
  ],

  // File handling modes
  [
    "Which of the following modes opens a file for both reading and writing in Python?",
    "\"r+\"", "\"w+\"", "\"a+\"", "\"r\""
  ],
  [
    "What is the default mode in which the open() function opens a file if the mode is not specified?",
    "\"r\"", "\"w\"", "\"a\"", "\"b\""
  ],
  [
    "What does the tell() function do in Python file handling?",
  ...
  [
    "Which of the following methods is used to rename a file in Python?",
    "os.rename()", "os.move()", "os.path.rename()", "os.renamefile()"
  ],
  [
    "Which statement is correct for the with keyword in Python file handling?",
    "It automatically closes the file when the block inside it is exited.",
    "It automatically opens a file in write mode.",
    "It writes data to the file automatically.",
    "It reads data from the file automatically."
  ],

  // Advanced file handling
  [
    "How do you read all the lines in a file into a list in Python?",
    "file.readlines()", "file.readline()", "file.read()", "file.line()"
  ],
  [
    "Which method is used to move the file pointer to the beginning of a file?",
    "file.seek(0)", "file.tell(0)", "file.reset()", "file.start()"
  ],
  [
  ...
  [
    "In object-oriented programming, which keyword is used to inherit from a parent class?",
    "class ChildClass(ParentClass)", "class ChildClass extends ParentClass",
    "class ChildClass implements ParentClass", "class ChildClass inherits ParentClass"
  ],
  [
    "Which of the following is NOT a benefit of using object-oriented programming?",
    "Reusability of code", "Encapsulation", "Global variables", "Modularity"
  ],

  // Object-oriented programming and file operations
  [
    "Which of the following methods is used to delete a file in Python?",
    "os.remove()", "os.delete()", "os.unlink()", "os.del()"
  ],
  [
    "Which of the following file modes opens a file for appending in Python?",
    "\"a\"", "\"w\"", "\"r\"", "\"x\""
  ],
  [
    "What does the flush() method do in Python file handling?",
    "Forces the file to be written to disk immediately",
    "Closes the file",
    "Opens the file",
    "Deletes the file"
  ],
  [
    ...
    "class MyClass:", "MyClass class:", "def class MyClass:", "MyClass():"
  ],
  [
    "What will the following code do?\n\nwith open('file.txt', 'r') as file:\n  data = file.read()",
    "Open file.txt in read mode and store its content in the variable data",
                                              ...
                                              'https://w7.pngwing.com/pngs/827/120/png-transparent-educational-assessment-test-computer-icons-risk-assessment-assess-angle-text-logo-thumbnail.png'),
                                                                        ...
                                                                        TextButton(
                                                                          ...
                                                                          onPressed:
                                                                            ...
                                                                            Navigator.push(
                                                                              context,
                                                                              MaterialPageRoute(builder: (context) => PdfPageUnit3()),
                                                                            );
                                                                          },
                                                                        ),
],
...
Widget _buildQuestionWidget(int questionNumber, List<String> question) {
  ...
  DataSnapshot snapshot = await databaseReference.child('AIPT-Unit3').child(enrollmentNo).get();
          ...
          actions: <Widget>[
            TextButton(
              onPressed: () async {
                ...
                await databaseReference.child('AIPT-Unit3').child(enrollmentNo).set({
                  '1_Name': name,
                  '2_Total Marks': questions.length,
                  '3_Marks obtained': correctCount,
                  '4_Correct': correctCount,
