...
import 'AIPT-ReportUnit2.dart';
import 'ReportGenerationCOA.dart';



class AIbasedProgrammingToolsUnit2 extends StatefulWidget {
  @override
  _AIbasedProgrammingToolsUnit2State createState() => _AIbasedProgrammingToolsUnit2State();
}

class _AIbasedProgrammingToolsUnit2State extends State<AIbasedProgrammingToolsUnit2> {
...
late String section2= controller.text;
 ...
 List<String> correctAnswers = [
  // Python basics
  "Dynamically typed",  // Question 1
  "def",  // Question 2
  "Local",  // Question 3
  "return",  // Question 4
  "TensorFlow",  // Question 5

  // Functions and scope
  "5",  // Question 6
  "10",  // Question 7
  "They are anonymous functions",  // Question 8
  "[1], [1, 1]",  // Question 9
  "A file containing Python code",  // Question 10

  // Advanced concepts
  "To return a value to the calling function",  // Question 11
  "A function that calls itself",  // Question 12
  "A collection of modules",  // Question 13
  "import module_name",  // Question 14
  "It's a machine learning library",  // Question 15
  "def func(a=1, b=2):",  // Question 16
  "8",  // Question 17
  "Dynamic computation graph",  // Question 18
  "To define anonymous functions for short-term use",  // Question 19
  "3 2 1",  // Question 20
];
...
List<List<String>> questions = [
  ...
  [
    ...
    "Statically typed", "Dynamically typed", "Compiled", "Not interpreted"
  ],
  [
  ...
  [
    ...
    "Global", "Local", "Static", "Universal"
  ],
  [
    "Which of the following is used to return a value from a function?",
    "break", "pass", "return", "exit"
  ],
  [
    "Which of these is a Python package for deep learning?",
  ...
  [
    ...
    "They are defined using the keyword def",
    "They are used to create complex functions"
  ],
  [
  ...
  [
    ...
    "A function", "A package", "A file containing Python code", "A library"
  ],
  ...
  [
    "Which of the following is true about recursive functions in Python?",
    "A function that calls another function",
    "A function that calls itself",
    "A function that runs indefinitely",
    "A function that does not use the return statement"
  ],
  [
    "What is a Python package?",
    "A single module", "A collection of modules", "A data structure", "A built-in function"
  ],
  [
    "How do you import a module in Python?",
    "include module_name", "import module_name", "define module_name", "load module_name"
  ],
  [
    "Which of the following is true about TensorFlow?",
    "It's a Python IDE", "It's a machine learning library", "It's a web framework", "It's a database"
  ],
  [
    "How do you define a function with default parameters in Python?",
    "def func(a=1, b):", "def func(a, b=2):", "def func(a=1, b=2):", "def func(a, b):"
  ],
  [
    "What is the output of the following code?\n\ndef add(x, y):\n  return x + y\nresult = add(3, 5)\nprint(result)",
    "35", "8", "None", "Error"
  ...
  [
    "Which of these is a key feature of PyTorch?",
  ...
  [
    "What is the primary use of lambda functions?",
    "To define named functions",
    "To define anonymous functions for short-term use",
    "To create complex functions with multiple lines",
    "To perform input/output operations"
  ],
  [
    "What will be the output of this code?\n\ndef countdown(n):\n  if n == 0:\n    return\n  else:\n    print(n)\n    countdown(n-1)\ncountdown(3)",
    "3 2 1", "1 2 3", "3 2 1 0", "Error"
  ],
];
                                              ...
                                              'https://w7.pngwing.com/pngs/827/120/png-transparent-educational-assessment-test-computer-icons-risk-assessment-assess-angle-text-logo-thumbnail.png'),
                                                                        ...
                                                                        TextButton(
                                                                          ...
                                                                          onPressed:
                                                                            ...
                                                                            Navigator.push(
                                                                              context,
                                                                              MaterialPageRoute(builder: (context) => PdfPageUnit2()),
                                                                            );
                                                                          },
                                                                        ),
],
...
Widget _buildQuestionWidget(int questionNumber, List<String> question) {
  ...
  DataSnapshot snapshot = await databaseReference.child('AIPT-Unit2').child(enrollmentNo).get();
          ...
          actions: <Widget>[
            TextButton(
              onPressed: () async {
                ...
                await databaseReference.child('AIPT-Unit2').child(enrollmentNo).set({
                  '1_Name': name,
                  '2_Total Marks': questions.length,
                  '3_Marks obtained': correctCount,
                  '4_Correct': correctCount,
